                                                ...
                                                <div style="height: 500px;width: 820px;overflow: auto;">
                                                    <table cellpadding="5" cellspacing="5" border="0">
                                                        ...
                                                        <tr align="center">
                                                            ...
                                                            <td class="heading_lable">Payment From</td>
                                                            <td class="heading_lable">Bank Name</td>
                                                            <td class="heading_lable">Project Name</td>
                                                            <td class="heading_lable">Project Cost</td>
                                                            <td class="heading_lable">Transfer From</td>
                                                            <td class="heading_lable">Transfer To</td>
                                                            <td class="heading_lable">Transfer Amount</td>
                                                            <td class="heading_lable">Transfer Date</td>
                                                        </tr>
                                                        <?php
                                                        $query = "select * from payment where a1 = '$user_id'";
