                                            ...
                                            <form action="ProductSave.php" method="post" enctype="multipart/form-data">
                                                <div style="height: 500px;width: 820px;overflow: auto;">
                                                    <table cellpadding="5" cellspacing="5" border="0">
                                                        ...
                                                        <tr align="center">
                                                              <td class="heading_lable">Assign Project</td>
                                                            <td class="heading_lable">Project ID</td>
                                                            ...
                                                            <td class="heading_lable">Project Work</td>
                                                        ...
                                                        ?>
                                                            <tr>
          <td><a href="AssingProject.php?id=<?php echo $row['a1']; ?>"style="color:red;text-decoration:none"> Project Status</a></td>
